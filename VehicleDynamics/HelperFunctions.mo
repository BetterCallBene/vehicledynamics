...
package HelperFunctions "Useful function for vehicle dynamics package"
...
function primary "Evaluate primary of an expression"
    ...
    *, /
    ...
    import Types = Modelica.Utilities.Types;
    ...
    input Real defaultValue "Default value if parameter not exists in file";
    ...
    if not found then
      assert(false, "Parameter \"" + name + "\" not found in file \"" + fileName + "\". Using default value: \"" + String(defaultValue) + "\"");
    end if;
