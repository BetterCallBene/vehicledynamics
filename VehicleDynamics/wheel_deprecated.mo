within vehicle_dynamics;

package wheel "Package wheel collect different types of approximation of wheel dynamics"
...
//VISUAL REPRESENTATION OF TYRE AND RIM
  ...
  connect(hub.frame_b, Tire.frame_a) annotation(
    ...
    model Example
      vehicle_dynamics.wheel.RillTyre.wheel wheel annotation(
